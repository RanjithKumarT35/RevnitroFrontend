                      ...
                      <div className="posterss">
                        <div className="personposted">
                            ...
                            <div>
                              ...
                              <div className="uernamepost">
                                ...
                                {thread.authorIsAdmin && (
                                  <img
                                    src="https://image.similarpng.com/thumbnail/2021/06/Blue-check-mark-icon-on-transparent-background-PNG.png"
                                    style={{
                                      backgroundColor: "cyan",
                                      borderRadius: "50%",
                                      width: "10px",
                          ...
                          <div className="postedtime">
                            👁️‍🗨️ {formatNumber(thread.views)} <strong> | </strong>
                                ...
                                <div id={thread._id}>
                                  {commenterNames.map((commenter) => (
                                    ...
                                    >
                                      ...
                                      />
                                      <span>{commenter.userIdentity}</span>
                                    </div>
                                  ))}
                                </div>
                              )}
                          ...
                          <div className="maincomment">
                            ...
                            >
                              ...
                              <TwitterShareButton
                                ...
                                title={`hey checkout this thread. Its very good \n"${thread.title}"\n`}
                              >
                                <XIcon size={32} round />
                              </TwitterShareButton>
                              ...
                              <EmailShareButton
                                url={`${window.location.origin}/${thread._id}`}
                                subject={`hey checkout this thread. Its very good \n"${thread.title}"\n`}
                              ...
                              >
                                <img
                                  src="https://storage.needpix.com/rsynced_images/share-icon-2215563_1280.jpg"
                                  alt=""
                                  style={{
                                    backgroundColor: "white",
                                    borderRadius: "50%",
                            ...
                            <div className="commentingarea" key={comment._id}>
                              ...
                              {(userIdentity === comment.commenterIdentity ||
                                ...
                                <div>
                                  ...
                                  >
                                    <img src="./images/commentDeleteImage.png" />
                                  </div>
                                </div>
                              )}
                            </div>
